...
Version 7 of the SDK is compatible with Sentry self-hosted versions 25.2.0 or higher (unchanged from v6). Lower versions may continue to work, but may not support all features.
