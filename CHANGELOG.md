...
- Expose `reportAccessibilityIdentifier` (iOS) to omit PII accessibility identifiers from the view hierarchy ([#XXXX](https://github.com/getsentry/sentry-react-native/pull/XXXX))
