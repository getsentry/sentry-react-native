...
- Android Gradle plugin no longer writes generated `sentry.options.json` into your source tree during builds ([#6750](https://github.com/getsentry/sentry-react-native/issues/6750))
