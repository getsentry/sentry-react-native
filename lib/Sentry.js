...
export const Sentry = {
  ...
  setEnvironment(environment) {
    Sentry._log('react-native-sentry (setEnvironment)');
    Sentry._setInternalOption('environment', environment);
    if (Sentry._ravenClient) Sentry._ravenClient.setEnvironment(environment);
  },
