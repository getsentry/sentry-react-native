...
public class RNSentryStart {
    ...
    public void startWithOptions(@NotNull final Context context,
                         @NotNull final ReadableMap rnOptions,
                         @Nullable Activity currentActivity,
                         @NotNull ILogger logger) {
        SentryAndroid.init(context, options -> getSentryAndroidOptions(options, rnOptions, currentActivity, logger));
    }

    protected void getSentryAndroidOptions(
            @NotNull SentryAndroidOptions options, @NotNull ReadableMap rnOptions, @Nullable Activity currentActivity, ILogger logger) {
