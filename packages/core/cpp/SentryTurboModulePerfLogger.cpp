...
#define SENTRY_FORWARD3(name, t1, n1, t2, n2, t3, n3)                  \
  ...
  SENTRY_FORWARD2(syncMethodCallArgConversionEnd, const char*, moduleName, const char*, methodName)
  ...
  SENTRY_FORWARD3(asyncMethodCallExecutionStart, const char*, moduleName, const char*, methodName, int32_t, id)
  SENTRY_FORWARD3(asyncMethodCallExecutionArgConversionStart, const char*, moduleName, const char*, methodName, int32_t, id)
  SENTRY_FORWARD3(asyncMethodCallExecutionArgConversionEnd, const char*, moduleName, const char*, methodName, int32_t, id)
  SENTRY_FORWARD3(asyncMethodCallExecutionEnd, const char*, moduleName, const char*, methodName, int32_t, id)
  SENTRY_FORWARD3(asyncMethodCallExecutionFail, const char*, moduleName, const char*, methodName, int32_t, id)
...
SentryTurboModulePerfController& SentryTurboModulePerfController::instance() noexcept {
...
void SentryTurboModulePerfController::install() noexcept {
#if SENTRY_TM_PERF_LOGGER_AVAILABLE
...
void SentryTurboModulePerfController::setSink(std::shared_ptr<ISentryTurboModulePerfSink> sink) noexcept {
  std::lock_guard<std::mutex> lock(sink_mutex_);
  sink_ = std::move(sink);
}

std::shared_ptr<ISentryTurboModulePerfSink> SentryTurboModulePerfController::sink() const noexcept {
  std::lock_guard<std::mutex> lock(sink_mutex_);
  return sink_;
}

void SentryTurboModulePerfController::setEnabled(bool enabled) noexcept {
  enabled_.store(enabled, std::memory_order_release);
}

bool SentryTurboModulePerfController::isEnabled() const noexcept {
