...
import type { FeedbackWidgetProps, FeedbackWidgetState, FeedbackWidgetStyles, FeedbackGeneralConfiguration, FeedbackTextConfiguration, ImagePickerConfiguration } from './FeedbackWidget.types';
