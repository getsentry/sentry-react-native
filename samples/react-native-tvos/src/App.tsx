/**
 * Sentry React Native tvOS Sample
 *
 * @format
 */
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        <View style={styles.body}>
          <Text style={styles.title}>Sentry React Native tvOS</Text>
          <Button
            title="Capture message"
            onPress={() => {
              Sentry.captureMessage('Hello from the tvOS sample!');
            }}
          />
          ...
          <Button
            ...
            onPress={() => {
              Sentry.captureException(
                new Error('First error from the tvOS sample!'),
              );
            }}
          />
          <View style={styles.spacer} />
          <Button
            ...
            onPress={() => {
              throw new Error('Unhandled error from the tvOS sample!');
            }}
          />
        </View>
      </ScrollView>
